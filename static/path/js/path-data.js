...
export const CATALOG = {
  ...
  'threejs':           { en: '/news/threejs-webxr-starter/',                   ja: '/ja/news/threejs-webxr-入門/',                     t_en: 'Three.js: the standard library of WebXR', t_ja: 'Three.js で WebXR' },
  ...
  'video-to-splats':   { en: '/news/video-to-gaussian-splats/',                ja: '/ja/news/video-to-gaussian-splats-入門/',          t_en: 'Video to Gaussian splats',               t_ja: 'ビデオからガウシアンスプラット' },
  'youtube-vr':        { en: '/news/spatial-video-youtube-vr/',                ja: '/ja/news/spatial-video-youtube-vr-入門/',          t_en: 'Camera to YouTube VR (no-code)',          t_ja: 'カメラから YouTube VR' },
...
export const PATHS = {
  ...
  P3: {
    ...
    articles: ['aframe', 'threejs', 'babylon', 'iwsdk'], avpRuntime: true,
    devices: [
      { name: 'Meta Quest 3', url: 'https://www.meta.com/quest/quest-3/' },
      { name: 'PICO 4 Ultra Enterprise', url: 'https://www.picoxr.com/global/products/pico4-ultra-enterprise' },
    ],
  },
  P4: {
  ...
  P8: {
    ...
    articles: ['spatial-video', 'youtube-vr', 'video-to-splats', 'scaniverse', 'gs-360', 'sharp', 'lito', 'make-art', 'lichtfeld'], avpRuntime: true,
...
export const STRINGS = {
  en: {
    ...
    result_devices: 'Headsets on hand at the event',
