...
ネイティブプラットフォームの流れ（[Spectacles](/ja/news/snap-spectacles-lens-studio-入門/)、[Meta Ray-Ban Display](/ja/news/meta-wearables-webapp-sdk-入門/) に続く）の今回は **Apple Vision Pro / visionOS**。そして、ぜひ紹介したいコミュニティのつながりがあります。
...
- 関連：[Snap Spectacles と Lens Studio](/ja/news/snap-spectacles-lens-studio-入門/) ・ [Meta Ray-Ban Display Web Apps](/ja/news/meta-wearables-webapp-sdk-入門/)
