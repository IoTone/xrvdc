...
> The skillset is MIT, but it calls paid third-party APIs (World Labs, FAL/Hunyuan, ElevenLabs) — bring API keys and credits. This is also why it pairs well with our [3DGS-from-360°-camera workflow](/staging/news/3dgs-360-camera-workflow/): both end in a Gaussian splat you have to get on-device.
...
- **Best polish/perf** comes from this engine route; if you just need *something running today* across Quest 3 + Vision Pro, the [WebXR route](/staging/news/aframe-webxr-starter/) is faster to first pixel.
...
- Related: [3DGS from a 360° camera](/staging/news/3dgs-360-camera-workflow/) · [A-Frame / WebXR](/staging/news/aframe-webxr-starter/) · [visionOS on-ramp](/staging/news/visionos-2-30-days/)
- [Hackathon details](/staging/hackathon/) — eligibility, team formation, AI policy
- [Register on Luma](https://luma.com/i5gerreb)

Questions? Reach us via the [Contact](/staging/contact/) page.
